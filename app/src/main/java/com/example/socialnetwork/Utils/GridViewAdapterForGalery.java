...
public class GridViewAdapterForGalery extends ArrayAdapter<String> {
    private Context mContext;
    private int layoutResource;
    private String append;

    public GridViewAdapterForGalery(@NonNull Context context, int resource, String append, ArrayList<String> imagePath) {
